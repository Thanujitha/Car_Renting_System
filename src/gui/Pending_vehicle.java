 ...
 * @author Thanujitha
 */
public class Pending_vehicle extends javax.swing.JPanel {

    /**
     * Creates new form Pending_vehicle
     */
    public Pending_vehicle() {
        initComponents();
        lordTable();
        lordBrand();
        lordModel();
    ...
    public void lordTable() {
        try {
            ...
            ResultSet rs = MySql.search("SELECT * FROM add_new_vehical INNER JOIN user ON user.id=add_new_vehical.user_id INNER JOIN vehicle_brand ON vehicle_brand.id=add_new_vehical.vehicle_brand_id\n"
                    ...
                    + "WHERE vehicle_colity.name='None' ORDER BY add_new_vehical.id ASC;");
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("vehicle_status.name"));
                dtm.addRow(v);
            }
    ...
    public void search() {
        try {
            ...
            ResultSet rs = MySql.search("SELECT * FROM add_new_vehical INNER JOIN user ON user.id=add_new_vehical.user_id INNER JOIN vehicle_brand ON vehicle_brand.id=add_new_vehical.vehicle_brand_id\n"
                    + "INNER JOIN vehicle_model ON vehicle_model.id=add_new_vehical.vehicle_model_id INNER JOIN vehicle_status ON vehicle_status.id = add_new_vehical.vehicle_status_id\n"
                    + "INNER JOIN vehicle_colity ON vehicle_colity.id= add_new_vehical.vehicle_colity_id INNER JOIN vehicle_type ON vehicle_type.id = add_new_vehical.vehicle_type_id \n"
                    + "" + wherequerty + " vehicle_status.name='None' ORDER BY add_new_vehical.id ASC;");
            ...
            while (rs.next()) {
                ...
                v1.add(rs.getString("vehicle_status.name"));
                dtm.addRow(v1);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Vehicle No", "supplier name", "supplier mobile number", "Brand", "Model", "Type", "status"
            }
        ) {
        ...
        jLabel1.setText("Vehicles to be checked ");
        ...
        // TODO add your handling code here:
         ...
         if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                Check_vehicle_colity av=new Check_vehicle_colity(id,this);
                av.setVisible(true);
